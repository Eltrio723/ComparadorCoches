 ...
 <header class="cabecera" >
    ...
    <main class="main">
    	<form class="cuadro" method="GET" action="/buscador">
            ...
            <label class="formulario" for="correo">Fecha Máxima de matriculación <br>
    ...
    <section class="derecha">
    	<img id="logo1" src="https://cdn.pixabay.com/photo/2013/07/13/11/36/volkswagen-158463_960_720.png" alt="LOGO PRINCIPAL DE LA PÁGINA">
    </section>
     </main>
     <footer class="pie">
    ...
    <!-- <h1>Hola práctica de ISI!</h1>
	<h2>Antonio Jiménez</h2>
	<h2>Andrés López</h2> -->
    <table>
      <tr>
